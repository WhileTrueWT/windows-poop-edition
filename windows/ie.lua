...
window.icon = "images/icons/ie.png"
...
local function search()
    textInput("Type something to search", function(text)
        if #text > 0 and love.filesystem.getInfo("_NOTHING/net/" .. text .. ".lua") then
            goToPage(text)
        else
