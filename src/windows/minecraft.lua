...
function screens.loading.draw()
    image("images/minecraft/jomang.png", 0, 0, windowWidth, windowHeight)
end
...
function screens.title.draw()
    image("images/minecraft/minecraft-background.png", 0, 0, windowWidth, windowHeight)
    image("images/minecraft/minecraft-logo.png", windowWidth/2 - 420, 150)
    love.graphics.push()
